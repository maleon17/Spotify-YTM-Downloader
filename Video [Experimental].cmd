...
:dl_video
"%~dp0Redistributables\YouTube-DL\youtube-dl.exe" -o "%~dp0%OUT%" --no-warnings --embed-metadata --restrict-filenames --ffmpeg-location "%~dp0Redistributables\FFMPEG\bin\ffmpeg.exe" %URL%
exit /b

:dl_audio
"%~dp0Redistributables\YouTube-DL\youtube-dl.exe" -o "%~dp0%OUT%" -x --audio-format mp3 --no-warnings --embed-metadata --audio-quality 0 --restrict-filenames --ffmpeg-location "%~dp0Redistributables\FFMPEG\bin\ffmpeg.exe" %URL%
exit /b